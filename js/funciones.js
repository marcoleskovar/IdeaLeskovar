...
//INPUT DE CANTIDAD EN ELEGIDO = START
...
//INPUT DE CANTIDAD EN ELEGIDO = END


//CREAR LISTA DE CANTIDAD = START
...
//CREAR LISTA DE CANTIDAD = END


//APLICAR CANTIDAD AL BOTON Y CERRAR LISTA = START
const seleccionarLaCantidad = (id, cantidad) =>{
    const botonCantidad = document.getElementById(`agregarPorCantidad-${id}`)
    botonCantidad.innerHTML = cantidad == 1 ? `${cantidad} unidad` : `${cantidad} unidades`;
    const lista = document.getElementById(`listaCantidadProducto`);
    lista.classList.remove('active');
    const arrow = document.getElementById(`arrowCantidad`)
    arrow.classList.remove('active')
}
//APLICAR CANTIDAD AL BOTON Y CERRAR LISTA = END
